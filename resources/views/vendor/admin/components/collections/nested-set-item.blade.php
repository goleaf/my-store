...
<div class="relative group">
                ...
                >
                    <div class="flex items-center space-x-2">
                        <div>
                            ...
                            @else
                                <x-filament::icon alias="store::image-placeholder" class="p-1 text-gray-200 w-10 h-10" />
                            @endif
                        </div>
    ...
    @if (count($children))
        <div style="margin-left:40px;" class="my-2 space-y-2">
            <x-admin::collections.nested-set-tree :nodes="$children" :group="'parent_id_'.$parent"/>
        </div>
    @endif
</div>