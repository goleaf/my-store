<div class="px-2 pb-4 scroll-mt-32" id="store-panel-timeline">
                                    ...
                                    <div @class([
                                        ...
                                        <div>
                                            <div class="text-xs font-medium text-gray-500 dark:text-gray-400">
                                                @if (!$item['log']->causer)
                                                    {{ __('admin::components.activity-log.system') }}
                                                @else
                                                    {{ $logUserName }}
                                                @endif
                                            </div>
    ...
    <div class="pt-4">
        {{ $this->activityLog->links('admin::components.activity-log.timeline-paginator.index', data: ['scrollTo' => '#admin-panel-timeline']) }}
    </div>
</div>
