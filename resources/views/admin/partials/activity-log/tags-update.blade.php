<div class="grid gap-1">
    <span>{{ __('admin::components.activity-log.partials.tags.updated') }}</span>

    @if(filled($added))
        <div class="flex items-center gap-2">
            <span class="text-xs font-normal">
                {{ __('admin::components.activity-log.partials.tags.added') }}
            </span>
    ...
    @if(filled($removed))
        <div class="flex items-center gap-2">
            <span class="text-xs font-normal">
                {{ __('admin::components.activity-log.partials.tags.removed') }}
            </span>
