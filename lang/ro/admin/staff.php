...
return [
    ...
    'acl' => [
        ...
        'notification' => [
            'updated' => 'Actualizat',
            'error' => 'Eroare',
            'no-role' => 'Rolul nu este înregistrat în Store',
            'no-permission' => 'Permisiunea nu este înregistrată în Store',
            'no-role-permission' => 'Rolul și permisiunea nu sunt înregistrate în Store',
        ],
    ],
