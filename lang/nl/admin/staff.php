...
return [
    ...
    'acl' => [
        ...
        'notification' => [
            'updated' => 'Bijgewerkt',
            'error' => 'Fout',
            'no-role' => 'Rol niet geregistreerd in Store',
            'no-permission' => 'Machtiging niet geregistreerd in Store',
            'no-role-permission' => 'Rol en Machtiging niet geregistreerd in Store',
        ],
    ],
