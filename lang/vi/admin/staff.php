...
return [
    ...
    'acl' => [
        ...
        'notification' => [
            'updated' => 'Đã cập nhật',
            'error' => 'Lỗi',
            'no-role' => 'Vai trò chưa được đăng ký trong Store',
            'no-permission' => 'Quyền chưa được đăng ký trong Store',
            'no-role-permission' => 'Vai trò và quyền chưa được đăng ký trong Store',
        ],
    ],
