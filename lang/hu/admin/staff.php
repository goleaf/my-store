...
return [
    ...
    'acl' => [
        ...
        'notification' => [
            'updated' => 'Frissítve',
            'error' => 'Hiba',
            'no-role' => 'A szerepkör nincs regisztrálva a Storeban',
            'no-permission' => 'A jogosultság nincs regisztrálva a Storeban',
            'no-role-permission' => 'Szerepkör és jogosultság nincs regisztrálva a Storeban',
        ],
    ],
