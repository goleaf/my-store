...
return [
    ...
    'acl' => [
        ...
        'notification' => [
            'updated' => 'Mis à jour',
            'error' => 'Erreur',
            'no-role' => 'Rôle non enregistré dans Store',
            'no-permission' => 'Autorisation non enregistrée dans Store',
            'no-role-permission' => 'Rôle et autorisation non enregistrés dans Store',
        ],
    ],
