...
class ManageUrlsRelatedRecords extends BaseManageRelatedRecords
{
    ...
    {
        return FilamentIcon::resolve('store::urls');
    }
            ...
            ->components([
                ...
                Forms\Components\Group::make([
                    ...
                    Forms\Components\Select::make('language_id')->label(
                        __('admin::relationmanagers.urls.table.language.label')
        ...
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\IconColumn::make('default')
                    ->label(
                        __('admin::relationmanagers.urls.table.default.label')
                    )
                    ->boolean(),
            ])
            ->filters([
                Tables\Filters\SelectFilter::make('language_id')
                    ->label(
                        __('admin::relationmanagers.urls.filters.language_id.label')
                    )
