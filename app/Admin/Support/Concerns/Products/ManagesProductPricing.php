...
namespace App\Admin\Support\Concerns\Products;
                ...
                collect($this->basePrices)->map(callback: function ($price, $index): Forms\Components\Fieldset {
                    return Forms\Components\Fieldset::make($price['label'])->schema([
                        Forms\Components\TextInput::make('value')
                            ...
                            ->numeric()
                            ->label(
                                __('admin::relationmanagers.pricing.form.basePrices.form.price.label')
                            )
                            ->helperText(
                                __('admin::relationmanagers.pricing.form.basePrices.form.price.helper_text')
                            )
                            ->hintColor('warning')
                            ...
                            ->hintIcon(function (Forms\Get $get, Forms\Components\TextInput $component) use ($index, $price) {
                                ...
                                return __('admin::relationmanagers.pricing.form.basePrices.tooltip');
                            })
                        ...
                        Forms\Components\TextInput::make('compare_price')
                            ...
                            ->numeric()
                            ->label(
                                __('admin::relationmanagers.pricing.form.basePrices.form.compare_price.label')
                            )
                            ->helperText(
                                __('admin::relationmanagers.pricing.form.basePrices.form.compare_price.helper_text')
                            )
                            ->hintColor('warning')
                            ->extraInputAttributes([
                                'class' => '',
