...
namespace App\Admin\Filament\Resources\ProductResource\Widgets;
        ...
        return Action::make('addSharedOption')
            ->form([
                Shout::make('no_shared_components')
                    ->content(
                        __('admin::productoption.widgets.product-options.actions.add-shared-option.form.no_shared_components.label')
                    )
                    ->visible(
                        $options->isEmpty()
                    ),
                Select::make('product_option')
                    ->options(
                        ...
                        __('admin::productoption.widgets.product-options.actions.add-shared-option.form.product_option.label')
                    )->visible(
                        $options->isNotEmpty()
                    ),
                Toggle::make('preselect')
                    ->default(true)
                    ->label(
                        __('admin::productoption.widgets.product-options.actions.add-shared-option.form.preselect.label')
                    )->visible(
                        $options->isNotEmpty()
                    ),
            ...
            ->action(function () {
                ...
                if (! count($this->variants)) {
                    ...
                    Notification::make()->title(
                        __('admin::productoption.widgets.product-options.notifications.save-variants.success.title')
                    )->success()->send();
