...
use App\Admin\Support\OrderStatus;
...
trait DisplaysOrderSummary
{
    public static function getDefaultOrderSummaryNewCustomerEntry(): Infolists\Components\TextEntry
    {
        return Infolists\Components\TextEntry::make('new_customer')
            ->label(__('admin::order.infolist.new_returning.label'))
            ->alignEnd()
            ->formatStateUsing(fn ($state) => __('admin::order.infolist.'.($state ? 'new' : 'returning').'_customer.label'));
    }

    public static function getOrderSummaryNewCustomerEntry(): Infolists\Components\Entry
    {
        return self::callStaticStoreHook('extendOrderSummaryNewCustomerEntry', static::getDefaultOrderSummaryNewCustomerEntry());
    }
    ...
    public static function getDefaultOrderSummaryStatusEntry(): Infolists\Components\TextEntry
    {
        return Infolists\Components\TextEntry::make('status')
            ->label(__('admin::order.infolist.status.label'))
    ...
    {
        return self::callStaticStoreHook('extendOrderSummaryStatusEntry', static::getDefaultOrderSummaryStatusEntry());
    }
    ...
    public static function getDefaultOrderReferenceEntry(): Infolists\Components\TextEntry
    {
        return Infolists\Components\TextEntry::make('reference')
            ->label(__('admin::order.infolist.reference.label'))
            ->alignEnd()
    ...
    {
        return self::callStaticStoreHook('extendOrderSummaryReferenceEntry', static::getDefaultOrderReferenceEntry());
    }
    ...
    public static function getDefaultOrderSummaryCustomerReferenceEntry(): Infolists\Components\TextEntry
    {
        return Infolists\Components\TextEntry::make('customer_reference')
            ->label(__('admin::order.infolist.customer_reference.label'))
            ->alignEnd()
            ->icon('heroicon-o-clipboard')
            ->iconPosition(IconPosition::After)
            ->copyable();
    ...
    {
        return self::callStaticStoreHook('extendOrderSummaryCustomerReferenceEntry', static::getDefaultOrderSummaryCustomerReferenceEntry());
    }
    ...
    public static function getDefaultOrderSummaryChannelEntry(): Infolists\Components\TextEntry
    {
        return Infolists\Components\TextEntry::make('channel.name')
            ->label(__('admin::order.infolist.channel.label'))
            ->alignEnd();
    }

    public static function getOrderSummaryChannelEntry(): Infolists\Components\Entry
    {
        return self::callStaticStoreHook('extendOrderSummaryChannelEntry', static::getDefaultOrderSummaryChannelEntry());
    }
    ...
    public static function getDefaultOrderSummaryCreatedAtEntry(): Infolists\Components\TextEntry
    {
        return Infolists\Components\TextEntry::make('created_at')
            ->label(__('admin::order.infolist.date_created.label'))
            ->alignEnd()
    ...
    {
        return self::callStaticStoreHook('extendOrderSummaryCreatedAtEntry', static::getDefaultOrderSummaryCreatedAtEntry());
    }
    ...
    public static function getDefaultOrderSummaryPlacedAtEntry(): Infolists\Components\TextEntry
    {
        return Infolists\Components\TextEntry::make('placed_at')
            ->label(__('admin::order.infolist.date_placed.label'))
            ->alignEnd()
            ->dateTime('Y-m-d h:i a')
            ->placeholder('-');
    }
    ...
    {
        return self::callStaticStoreHook('extendOrderSummaryPlacedAtEntry', static::getDefaultOrderSummaryPlacedAtEntry());
    }

    public static function getOrderSummarySchema(): array
    {
        return self::callStaticStoreHook('extendOrderSummarySchema', [
