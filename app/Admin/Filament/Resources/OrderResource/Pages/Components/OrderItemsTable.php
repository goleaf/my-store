...
namespace App\Admin\Filament\Resources\OrderResource\Pages\Components;
...
use App\Admin\Filament\Resources\ProductResource\Pages\EditProduct;
use App\Admin\Livewire\Components\TableComponent;
use App\Admin\Support\Concerns\CallsHooks;
use App\Admin\Support\Tables\Components\KeyValue;
...
class OrderItemsTable extends TableComponent
{
    ...
    {
        return self::callStaticStoreHook('extendOrderLinesTableColumns', [
            ...
            Tables\Columns\Layout\Panel::make([
                Tables\Columns\Layout\Stack::make([
                    Tables\Columns\TextColumn::make('stock')
                        ...
                        ->formatStateUsing(fn ($state) => __('admin::order.infolist.current_stock_level.message', [
                            'count' => $state,
                        ]))
                        ->colors(fn () => [
                    ...
                    Tables\Columns\TextColumn::make('meta.stock_level')
                        ->formatStateUsing(fn ($state) => __('admin::order.infolist.purchase_stock_level.message', [
                            'count' => $state,
                        ]))
                        ->color(Color::Gray),
                    Tables\Columns\TextColumn::make('notes')
                        ->description(new HtmlString('<b>'.__('admin::order.infolist.notes.label').'</b>'), 'above'),
    ...
    {
        return self::callStaticStoreHook('extendTable', $this->getDefaultTable($table));
    }
