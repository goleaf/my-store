...
class ManageVariantMedia extends BaseManageRelatedRecords
{
    ...
    {
        return __('admin::productvariant.pages.media.title');
    }
    ...
    public function table(Table $table): Table
    {
        return $table
            ->heading(function () {
                return __('admin::relationmanagers.medias.title');
            })
            ->description(function () {
                return __('admin::relationmanagers.medias.variant_description');
            })
            ...
            ->actions([
                Action::make('detach')
                    ->label(__('admin::relationmanagers.medias.actions.detach.label'))
