...
class ShippingZone extends BaseModel implements Contracts\ShippingZone
{
    ...
    public function countries(): BelongsToMany
    {
        return $this->belongsToMany(
            Country::modelClass(),
            config('store.database.table_prefix').'country_shipping_zone'
        )->withTimestamps();
    }
    ...
    public function orders(): BelongsToMany
    {
        return $this->belongsToMany(
            Order::modelClass(),
            config('store.database.table_prefix').'order_shipping_zone'
        )->withTimestamps();
    }
    ...
    public function states(): BelongsToMany
    {
        return $this->belongsToMany(
            State::modelClass(),
            config('store.database.table_prefix').'state_shipping_zone'
        )->withTimestamps();
    }
    ...
    public function shippingExclusions(): BelongsToMany
    {
        return $this->belongsToMany(
            ...
            config('store.database.table_prefix').'exclusion_list_shipping_zone',
            'shipping_zone_id',
            'exclusion_id',
        )->withTimestamps();
    }
