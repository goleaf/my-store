...
use App\Store\Console\Commands\AddonsDiscover;
use App\Store\Console\Commands\Import\AddressData;
use App\Store\Console\Commands\MigrateGetCandy;
use App\Store\Console\Commands\Orders\SyncNewCustomerOrders;
use App\Store\Console\Commands\PruneCarts;
use App\Store\Console\Commands\ScoutIndexerCommand;
use App\Store\Console\InstallLunar;
...
class StoreServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->loadTranslationsFrom(lang_path('vendor/store'), 'store');
    ...
    public function boot(): void
    {
        ...
        if ($this->app->runningInConsole()) {
            ...
            $this->publishes([
                lang_path('vendor/store') => lang_path('vendor/store'),
            ], 'store.translation');
