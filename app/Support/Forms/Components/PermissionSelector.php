...
{
    protected string $view = 'admin::forms.components.permission-selector';
    ...
    protected function setUp(): void
    {
        ...
        $this->saveRelationshipsUsing(static function (PermissionSelector $component, ?array $state) {
            ...
            $admins = AdminAccessControl::getAdmin()->intersect($selectedRoles);

            $filteredRoles = collect($selectedRoles)->reject(fn ($r) => $admins->contains($r));

            foreach ($filteredRoles as $role) {
                $roleModel = Role::findByName($role, AdminPanel::getPanel()->getAuthGuard());
            ...
            $groupedPermissions = AdminAccessControl::getGroupedPermissions();
    ...
    public function getPermissionState(): array
    {
        ...
        if (is_null($state)) {
            $state = AdminAccessControl::getPermissions()
    ...
    public function getPermissionRoles(): array
    {
        ...
        $roles = AdminAccessControl::getRolesWithoutAdmin()
